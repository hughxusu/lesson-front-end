...
<img src="./assets/pSRy1b9-20260817094140236.jpg" style="zoom:67%;" />
...
<img src="./assets/css-declaration-small.png" style="zoom: 55%;" />
...
<img src="./assets/rendering.svg" style="zoom: 10%;" />

1. 浏览器载入HTML文件。
2. 将HTML文件转化成一个DOM树，DOM树中的节点一般是一个标签。
3. 浏览器会载入与该HTML相关的资源，比如：图片、视频和CSS样式。
4. 浏览器对载入的CSS进行解析。浏览器根据选择器，将样式规则作用在对应的DOM的节点上。
6. 将处理后的网页渲染在屏幕上。

> [!important]
>
> DOM节点统称为页面元素，后面提到元素也指DOM节点或标签。
...
1. 生成李白的《侠客行》的网页，使用选择器控制标题和段落的字体颜色。

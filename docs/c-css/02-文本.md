...
![](./assets/main-qimg-bf0553b1b09f401fa6777971766554f5-pjlq.jpeg)
...
<img src="./assets/html-hex-colors.png" style="zoom:75%;" />
...
<img src="./assets/v2-eb5a7c60bd080db96536f0691a2c3a40_1440w.jpg" style="zoom: 75%;" />
...
<img src="./assets/pp9PqII.jpg" style="zoom:80%;" />
...
<img src="./assets/pp9ZeQx.png" style="zoom:30%;" />
...
1. 生成李白的《将近酒》的网页，满足如下要求：
   1. 网页有标题、作者和正文三个部分。
   2. 作者链接可以链接到百度百科。
   3. 字体使用是宋体，标题字体为36px，作者和正文使用20px。
   4. 行间距是1.5倍，中文段落要缩进两个字。
